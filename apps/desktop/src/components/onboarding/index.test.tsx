...
describe('onboarding Picker', () => {
  ...
  it('shows Fireworks first in the expanded list, ahead of other OAuth providers', () => {
    ...
    const labels = screen
      ...
      .filter(text => /Nous Portal|Fireworks AI|Codex App Server|MiniMax|OpenRouter/.test(text))
    ...
    expect(indexOf('Codex App Server')).toBeGreaterThan(indexOf('Fireworks AI'))
    expect(indexOf('MiniMax')).toBeGreaterThan(indexOf('Codex App Server'))
  })
