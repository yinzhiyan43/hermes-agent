 ...
 *
 * A public install can end up with `origin=git@github.com:yinzhiyan43/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/yinzhiyan43/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/yinzhiyan43/hermes-agent'
